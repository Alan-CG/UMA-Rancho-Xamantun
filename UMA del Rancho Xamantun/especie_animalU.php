<?php include 'model/modificar_especie_animal.php' ?>;
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="fixed-top-offset">
        <div class="container">
            ...
            <div class="card card-default border-light shadow p-3 mb-5">
                <form action="model/modificar_especie_animal.php" method="POST" class="needs-validation" novalidate>
            ...
            <div style="padding-bottom:0.5cm" class="row w-100 align-items-center">
                <div class="col text-center">
                    <a href="especie_animalR.php" class="btn btn-success bi bi-arrow-return-left"></a>
                </div>
            </div>
        </div>
