<?php include 'model/leer_datos_animales.php' ?>;
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="card card-default border-light shadow p-3 mb-5">
        <div class="form-row">
          <div class="form-group col">
            <a class="btn btn-success shadow-sm" href="especie_animalC.php">Nuevo registro</a>
          </div>
        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="bi bi bi-pencil-square btn btn-primary shadow-sm"
                        href="especie_animalU.php?id_especie=<?= $especie['id_especie'] ?>"></a>
                    </td>
                    <td>
                      <a class="bi bi-trash3-fill btn btn-danger shadow-sm"
                        href="model/borrar_especie_animal.php?id_especie=<?= $especie['id_especie'] ?>"></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
