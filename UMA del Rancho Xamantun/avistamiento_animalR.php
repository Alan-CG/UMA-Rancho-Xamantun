                  ...
                  <tr>
                    ...
                    <td>
                      <a class="bi bi bi-pencil-square btn btn-primary shadow-sm"
                        href="avistamiento_animalU.php?id_avistamiento=<?= $avistamiento['id_avistamiento'] ?>"></a>
                    </td>
                    <td>
                      <a class="bi bi-trash3-fill btn btn-danger shadow-sm"
                        href="model/borrar_avistamiento_animal.php?id_avistamiento=<?= $avistamiento['id_avistamiento'] ?>"></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
