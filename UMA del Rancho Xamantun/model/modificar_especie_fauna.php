...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $sql = "UPDATE especies_animales SET nombre_cientifico=:nombre_cientifico, nombre_comun=:nombre_comun, reino=:reino,filo=:filo,
        ...
        header('Location: ../especie_faunaR.php');
    } catch (PDOException $e) {
        echo "Ha ocurrido un error: " . $e->getMessage();
    }
} else {
    // Consulta SQL preparada para la inserción
    $sql2 = "SELECT * FROM especies_animales WHERE id_especie = :id";
