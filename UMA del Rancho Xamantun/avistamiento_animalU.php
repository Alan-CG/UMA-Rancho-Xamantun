...
<?php include 'model/modificar_avistamiento_animal.php' ?>;
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="fixed-top-offset">
        <div class="container">
            ...
            <div class="card card-default border-light shadow p-3 mb-5">
                <form action="model/modificar_avistamiento_animal.php" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
